 ...
 * @author jeevitha
 */
public class beauty_page extends javax.swing.JFrame {

    /**
     * Creates new form beauty_page
     */
    public beauty_page() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dbms/project/Banner2.jpg"))); // NOI18N
...
JCheckBox checkBox=new javax.swing.JCheckBox();
       ...
       System.out.println("hello1");
        ...
        ResultSet rs=stmt.executeQuery("SELECT sp.name,sp.price,sp.comp_name FROM SuppProd as sp,category as c Where sp.cat_id=c.cat_id AND c.type='beauty' AND sp.quantity>0;");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beauty_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
